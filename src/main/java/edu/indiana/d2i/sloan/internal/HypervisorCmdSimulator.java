...
public abstract class HypervisorCmdSimulator extends CommandSimulator {
	...
	public static enum ERROR_STATE {
		INVALID_INPUT_ARGS, IMAGE_NOT_EXIST, NOT_ENOUGH_CPU, NOT_ENOUGH_MEM, IO_ERR, VM_NOT_EXIST, FIREWALL_POLICY_NOT_EXIST, INVALID_VM_MODE, VM_STATE_FILE_NOT_FOUND
	}
	...
	public static enum CMD_FLAG_KEY {
		IMAGE_PATH, VCPU, MEM, WORKING_DIR, VNC_PORT, SSH_PORT, LOGIN_USERNAME, LOGIN_PASSWD, POLICY_PATH, VM_MODE, VM_STATE
	}
