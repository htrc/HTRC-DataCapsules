...
# msg = MIMEText("This is test content", 'plain')
# msg['Subject'] = "This is a test email"
# msg['From'] = "sharc"
#  
# conn = smtplib.SMTP_SSL("mail-relay.iu.edu", 465)
# conn.set_debuglevel(True)
# # conn.starttls()
# conn.login("sharc", "D2I-Shark.Tank.1s.Full")
# try:
#     conn.sendmail("sharc@indiana.edu", "jiaazeng@indiana.edu", msg.as_string())
# finally:
#     conn.close() 
