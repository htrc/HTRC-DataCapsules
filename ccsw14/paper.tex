...
%mode switch seamlessness (across machines)

%secure client access w/TPM
% -secure client
% -secure VNC connection

%managing migration speeds for performance & network

%automating part/all of result release audit
%\label{sec:Results Audit}

%evaluation plans and some preliminary results
